            ...
            <div class="intro-panel-inner">
              <div class="intro-title-block">
                <h1 class="intro-full-title">
                  <span>${escapeHtml((landing.section1TitleLines || [])[0] || '')}</span>
                  <span>${escapeHtml((landing.section1TitleLines || [])[1] || '')}</span>
                </h1>
                <div class="intro-title-subline">${(landing.section1NexusLines || []).map((line) => `<span>${escapeHtml(line)}</span>`).join('')}</div>
