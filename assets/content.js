...
export function getLandingText(language = 'en') {
  return LANDING_TEXT[language] || LANDING_TEXT.en;
}

export function getGuidanceText(language = 'en') {
  return STORY_GUIDANCE[language] || STORY_GUIDANCE.en;
}
...
export function actorLabel(actor, language = 'en') {
  return ACTOR_LABELS[actor]?.[language] || actor;
}
